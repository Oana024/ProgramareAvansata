...
public class PersonController {
    ...
    public PersonController() {
        ...
        personList.add(new Person(4, "Person4"));
        personList.add(new Person(5, "Person5"));
    }
    ...
    @GetMapping("/popularity/{k}")
    public List<Person> getMostPopularKPersons(@PathVariable int k) {
        List<Person> sortedList = new ArrayList<>();
        sortedList.addAll(personList);
        Collections.sort(sortedList, ((u, v) -> u.getFriendsNumber().compareTo(v.getFriendsNumber())));
